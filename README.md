...
The files within the config folder of each application and common folder requires a
...
* **environmentType** (required): can be "any" of the ones you configure on the
